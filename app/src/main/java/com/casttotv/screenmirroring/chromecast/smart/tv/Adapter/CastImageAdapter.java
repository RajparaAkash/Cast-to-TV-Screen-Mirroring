...
public class CastImageAdapter extends RecyclerView.Adapter<CastImageAdapter.ChannelHolder> {
    ...
    public CastImageAdapter(Context context, List<MediaModel> mediaList) {
    ...
    public ChannelHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.itemview_cast_image, parent, false);
